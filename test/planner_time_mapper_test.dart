...
void main() {
  group('PlannerTimeMapper', () {
    test('matches legacy linear behavior when cellGapHeight is zero', () {
      const mapper = PlannerTimeMapper(heightPerMinute: 1.25, cellGapHeight: 0);
    ...
    test('applies inter-hour gap in forward mapping and day height', () {
      const mapper = PlannerTimeMapper(heightPerMinute: 1, cellGapHeight: 8);
    ...
    test('inverse maps gap to nearest side', () {
      const mapper = PlannerTimeMapper(heightPerMinute: 1, cellGapHeight: 10);
    ...
    test('round-trips minute->y->minute across day with gaps', () {
      const mapper = PlannerTimeMapper(heightPerMinute: 0.9, cellGapHeight: 6);
